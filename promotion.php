...
<body>
    ...
    <div class="button-container">
        <a href="add/add_promotion.php" class="button">Add</a>
        <a href="delete/delete_promotion.php" class="button">Delete</a>
        <a href="select/select_promotion.php" class="button">Select</a>
